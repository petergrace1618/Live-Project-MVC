...
The question is: are the `Recipient` and `ProductionId` fields necessary to identify a record? I imagine the announcer at the ceremony presenting the award. 
...
An ad hoc solution? Probably. Completely robust? Probably not. But it got my pull request accepted. 
